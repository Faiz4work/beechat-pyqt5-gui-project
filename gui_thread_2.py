...
class Ui_Beechat_Networks(object):
    def setupUi(self, Beechat_Networks, device):
        ...
        # setting up Nunito font 
        QtGui.QFontDatabase.addApplicationFont("Nunito.ttf")
        self.font = QtGui.QFont("Nunito", 14)
        self.text_font = QtGui.QFont("Nunito", 12)
        
        Beechat_Networks.setFont(self.font)
        ...
        self.public_broadcast.setFont(self.font)
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 10, 400, 25))
        ...
        self.label_4.setFont(self.text_font)
        ...
        self.widget_6.setMinimumSize(QtCore.QSize(600, 120))
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 10, 400, 25))
        ...
        self.label_5.setGeometry(QtCore.QRect(30, 40, 450, 60))

        self.label_5.setFont(self.text_font)
        ...
        self.widget_7.setMinimumSize(QtCore.QSize(600, 80))
        ...
        self.label_6.setFont(self.text_font)
    ...
    def add_reply_widget(self):
        ...
        self.new_widget.setObjectName(f"new_widget_{self.my_counter}")
        ...
        self.new_frame.setObjectName(f"new_frame_{self.my_counter}")
        
        self.flabel_2 = QtWidgets.QLabel(self.new_frame)
        self.flabel_2.setGeometry(QtCore.QRect(30, 20, 431, 51))

        self.flabel_2.setFont(self.text_font)
        self.flabel_2.setStyleSheet("color: rgb(255, 255, 255);")
        self.flabel_2.setWordWrap(True)
        self.flabel_2.setObjectName(f"flabel_{self.my_counter}")
        self.flabel_2.setText(str(self.text))
        ...
        # print(dir(self.scrollArea.verticalScrollBarPolicy))
        # self.scrollArea.setValue(x)
        self.scrollArea.verticalScrollBar().setValue(x+x)
    ...
    def add_cilent_message_widget(self, device_id, client_message):
        ...
        self.new_widget = QtWidgets.QWidget(self.scrollAreaWidgetContents_2)
        self.new_widget.setMinimumSize(QtCore.QSize(600, 120))
        self.new_widget.setMaximumSize(QtCore.QSize(624, 200))
        # self.new_widget.setStyleSheet("background-color: #4857a8;")
        self.new_widget.setObjectName(f"client_widget_{self.client_counter}")
        ...
        self.new_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.new_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.new_frame.setObjectName(f"client_frame_{self.client_counter}")
        
        # Id label
        self.flabel_1 = QtWidgets.QLabel(self.new_frame)
        self.flabel_1.setGeometry(QtCore.QRect(30, 10, 400, 25))

        self.flabel_1.setFont(self.font)
        self.flabel_1.setStyleSheet("color: #a6a6a6;")
        self.flabel_1.setObjectName(f"label_{self.client_counter}")
        self.flabel_1.setText(str(self.device_id))
        
        self.flabel_2 = QtWidgets.QLabel(self.new_frame)
        self.flabel_2.setGeometry(QtCore.QRect(30, 40, 500, 60))

        self.flabel_2.setFont(self.text_font)
        self.flabel_2.setStyleSheet("color: rgb(255, 255, 255);")
        self.flabel_2.setWordWrap(True)
        self.flabel_2.setObjectName(f"flabel_{self.client_counter}")
